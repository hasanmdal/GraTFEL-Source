function [ AP,AUC,NDCGp ] = ClassifierAdaBoostM1( TrainPC, TrainLabel, TestPC, TestLabel,n,et)
    Mdl = fitensemble(TrainPC', TrainLabel,'AdaBoostM1',300,'Tree','LearnRate',0.1);
